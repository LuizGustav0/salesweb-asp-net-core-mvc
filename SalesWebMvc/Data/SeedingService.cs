...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Luiz", "luiz@gmail.com", new DateTime(1990, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Emanuela", "ema@gmail.com", new DateTime(1995, 6, 10), 1000.0, d1);
            Seller s3 = new Seller(3, "Jenifer", "jenifer@gmail.com", new DateTime(1998, 1, 25), 1000.0, d2);
            Seller s4 = new Seller(4, "Roberto", "ro@gmail.com", new DateTime(1980, 8, 30), 1000.0, d2);
            Seller s5 = new Seller(5, "João", "joao@gmail.com", new DateTime(1992, 12, 10), 1000.0, d3);
            Seller s6 = new Seller(6, "Cleiton", "cleiton@gmail.com", new DateTime(1979, 7, 1), 1000.0, d3);
